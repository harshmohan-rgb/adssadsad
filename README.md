...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/VlByPJGSgp)
...
```sh
npx nx serve cometchat-v4
```

To create a production bundle:

```sh
npx nx build cometchat-v4
```

To see all available targets to run for a project, run:

```sh
npx nx show project cometchat-v4
```
